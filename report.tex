...
% ---- Persönlichen Daten:
\newcommand{\titel}{Factorio is PSPACE-Complete}
\newcommand{\titelheader}{Trains, Games, and Complexity}
...
\newcommand{\NP}{\text{NP}}
\newcommand{\PO}{\text{P}}
\newcommand{\PSP}{\text{PSPACE}}
\newcommand{\NPSP}{\text{NPSPACE}}
...
\include{Inhalt/04_Inhalt/preliminaries}
\include{Inhalt/04_Inhalt/gadgets}
\include{Inhalt/04_Inhalt/factorio}
\include{Inhalt/04_Inhalt/summary}
